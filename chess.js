...
g1Div.addEventListener('click', () => {
    ...
    g8Div.addEventListener('click', () => {
        ...
        c8Div.addEventListener('click', () => {
            ...
            if (currentObject == e8Square && currentObject == c8Square && false == wKingMoved && false == a8RookMoved && b8Square.pieceType == '' && c8Square.pieceType == ''
                && 0 == c8Square.blackCount && 0 == e8Square.blackCount && 0 == d8Square.blackCount && d8Square.pieceType == '') {
                a1Square.pieceType = '';
                b1Square.pieceType = '';
                a1Square.pieceColor = '';
                b1Square.pieceColor = '';
