...
CheckForPin() {
  ...
  if (currentTurnColor == 'white' && whiteKingSquare.blackCount > 0) {
    updateRealWithPastBoard();
    resetCount();
    return false
  }
...
visualizePossibilities() {
  for (let i = 0; i < squaresArray.length; i++) {
    ...
    if (squaresArray[i].encounter == true) {
      divArray[i].style.backgroundImage = "url('./assets/red2.jpg')";
    } else if (squaresArray[i].possible == true) {
      divArray[i].style.backgroundImage = "url('./assets/index.png')";
    }
  }
...
unvisualizePossibilities() {
  for (let i = 0; i < squaresArray.length; i++) {
    ...
    if (squaresArray[i].encounter == false) {
      divArray[i].style.backgroundImage = "";
    } else if (squaresArray[i].possible == false) {
      divArray[i].style.backgroundImage = ''
    }
  }
}
...
checkSquaresAroundKing() {
  ...
  if ('black' == currentTurnColor) {
    ...
    if (findSquare(brow + 1, bcol) != undefined && findSquare(brow + 1, bcol).whiteCount == 0 && findSquare(brow + 1, bcol).pieceColor == '') {
      console.log('1');
      return true
    }
    if (findSquare(brow + 1, bcol + 1) != undefined && findSquare(brow + 1, bcol + 1).whiteCount == 0 && findSquare(brow + 1, bcol + 1).pieceColor == '') {
      console.log('2');
      return true
    }
    if (findSquare(brow, bcol + 1) != undefined && findSquare(brow, bcol + 1).whiteCount == 0 && findSquare(brow, bcol + 1).pieceColor == '') {
      console.log('3');
      return true
    }
    if (findSquare(brow - 1, bcol + 1) != undefined && findSquare(brow - 1, bcol + 1).whiteCount == 0 && findSquare(brow - 1, bcol + 1).pieceColor == '') {
    ...
    if (findSquare(brow + 1, bcol) != undefined && findSquare(brow + 1, bcol).whiteCount == 0 && findSquare(brow + 1, bcol).pieceColor == 'white') {
      console.log('9');
      return true
    }
    if (findSquare(brow + 1, bcol + 1) != undefined && findSquare(brow + 1, bcol + 1).whiteCount == 0 && findSquare(brow + 1, bcol + 1).pieceColor == 'white') {
      console.log('10');
      return true
    }
    if (findSquare(brow, bcol + 1) != undefined && findSquare(brow, bcol + 1).whiteCount == 0 && findSquare(brow, bcol + 1).pieceColor == 'white') {
      console.log('11');
      return true
    }
    if (findSquare(brow - 1, bcol + 1) != undefined && findSquare(brow - 1, bcol + 1).whiteCount == 0 && findSquare(brow - 1, bcol + 1).pieceColor == 'white') {
  ...
  if ('white' == currentTurnColor) {
    ...
    if (0 == findWhiteKing().blackCount) {
      return true;
    }

    //free squares
    if (findSquare(row + 1, col) != undefined && findSquare(row + 1, col).blackCount == 0 && findSquare(row + 1, col).pieceColor == '') {
      console.log('1');
      return true
    }
    if (findSquare(row + 1, col + 1) != undefined && findSquare(row + 1, col + 1).blackCount == 0 && findSquare(row + 1, col + 1).pieceColor == '') {
      console.log('2');
      return true
    }
    if (findSquare(row, col + 1) != undefined && findSquare(row, col + 1).blackCount == 0 && findSquare(row, col + 1).pieceColor == '') {
      console.log('3');
      return true
    }
    if (findSquare(row - 1, col + 1) != undefined && findSquare(row - 1, col + 1).blackCount == 0 && findSquare(row - 1, col + 1).pieceColor == '') {
    ...
    if (findSquare(row + 1, col) != undefined && findSquare(row + 1, col).blackCount == 0 && findSquare(row + 1, col).pieceColor == 'black') {
      console.log('9');
      return true
    }
    if (findSquare(row + 1, col + 1) != undefined && findSquare(row + 1, col + 1).blackCount == 0 && findSquare(row + 1, col + 1).pieceColor == 'black') {
      console.log('10');
      return true
    }
    if (findSquare(row, col + 1) != undefined && findSquare(row, col + 1).blackCount == 0 && findSquare(row, col + 1).pieceColor == 'black') {
      console.log('11');
      return true
    }
    if (findSquare(row - 1, col + 1) != undefined && findSquare(row - 1, col + 1).blackCount == 0 && findSquare(row - 1, col + 1).pieceColor == 'black') {
...
mateDirection(row, col, direction, startSquare) {
  ...
  if (findSquare(row, col).pieceColor != currentTurnColor && findSquare(row, col).pieceColor != '') {
    ...
    if (0 == findBlackKing().whiteCount && currentTurnColor == 'black') {
      checkMate = false;
    }
    if (0 == findWhiteKing().blackCount && currentTurnColor == 'white') {
      checkMate = false;
    }
    altSnapshot();
    return
...
pieceChecker(clickedSquare, row, col, ) {
  ...
  if ('pawn' == clickedSquare.pieceType && 'white' == currentTurnColor) {
    return wPawn(row, col)
  }
  if ('pawn' == clickedSquare.pieceType && 'black' == currentTurnColor) {
    return bPawn(row, col)
  }
}
...
mainEventFunction(currentSquare) {
  ...
  if (rightTradeSquare == currentSquare && currentTurnColor == 'black') {
    bEnPassantRightMove(currentSquare.row, currentSquare.col);;
    changeTurn();
    return
  }
  if (leftTradeSquare == currentSquare && currentTurnColor == 'black') {
    bEnPassantLeftMove(currentSquare.row, currentSquare.col);
    changeTurn();
    return
  }

  if (rightTradeSquare == currentSquare && currentTurnColor == 'white') {
    wEnPassantRightMove(currentSquare.row, currentSquare.col);
    changeTurn();
    return
  }
  if (leftTradeSquare == currentSquare && currentTurnColor == 'white') {
    wEnPassantLeftMove(currentSquare.row, currentSquare.col);
    changeTurn();
    return
  }
